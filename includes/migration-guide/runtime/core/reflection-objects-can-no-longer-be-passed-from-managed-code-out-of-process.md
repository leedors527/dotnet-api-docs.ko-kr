### <a name="reflection-objects-can-no-longer-be-passed-from-managed-code-to-out-of-process-dcom-clients"></a>리플렉션 개체 더 이상 관리 코드에서-out-of-process DCOM 클라이언트로 전달할 수
